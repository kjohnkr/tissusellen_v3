        ...
        <div class="form-group row">
          ...
          <div class="col-md-9">
            <textarea
              ...
              rows="3"
            >{if $contact.message}{$contact.message}{elseif $smarty.get.csId && $smarty.get.csName}Bonjour,

              Je souhaiterai obtenir des informations quant à la disponibilité du produit "{$smarty.get.csName}" (référence {$smarty.get.csId})
              
              Merci d'avance{/if}</textarea>
          </div>
        </div>
