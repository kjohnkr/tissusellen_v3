...
<section id="js-checkout-summary" class="card js-cart"
  data-refresh-url="{$urls.pages.cart|escape:'htmlall':'UTF-8'}?ajax=1&action=refresh">
            ...
            <ul class="media-list">
              {foreach from=$cart.products item=product}
                ...
                {if (Configuration::get('squaremeter_cartupdate') == 'on')}
                  <li class="media">{include file='checkout/_partials/cart-summary-product-line-override.tpl' product=$product}
                  </li>
                {else}
